...
namespace BlazingBlog.Migrations
{
    ...
    [Migration("20231220150504_AddNameToApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazingBlog.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BlazingBlog.Data.Entities.BlogPost", b =>
                {
                    ...
                    b.HasOne("BlazingBlog.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlazingBlog.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
